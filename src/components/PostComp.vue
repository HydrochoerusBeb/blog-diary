    ...
    <div class='post-wrapper'>
        ...
        <div class='func-section' v-if="isShow">
            <div class="newComm-section">
                ...
                <button @click='postStore.addComm(id, newComm)'>New comm</button>
            </div>
            <div class="comment-section">
                <div class='comment' v-for="(comment, index) in comments" :key="index">
                    <p>{{comment.text}}</p>
                    <button class='comment-button' @click='postStore.deleteComm(id, comment.id)'>Удалить комментарий</button>
                </div>
            </div>
        </div>
        <div v-if="isShowModal">
            <div class="modal-container">
                <div class="modal-content">     
                    ...
                    <div class='button-space'>
                        <button @click='postStore.changePost(id, newTitle);'>Change</button>
                        <button @click='openModal'>close</button>
                    </div>
                </div>
            </div>
        </div>
